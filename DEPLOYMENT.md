...
3. Install the wheel in a fresh environment using
   `python -m pip install labelerpy-0.2.2-py3-none-any.whl endompy-0.7.0-py3-none-any.whl`.
...
See docs/en/engih-deployment.md and docs/es/engih-deployment.md. ENGIH matches engihr 0.2.0; 30 metadata files retain the original bytes and revision hashes.
